...
createPost(
    {
        ...
        content: '<img src="../resources/images/s26/s26-feb-sched.png" alt="First Night Trivia Flyer" style="width:100%"/><i style="margin-right:5px" class="ri-calendar-fill"></i><b style="font-size:16px">February 2026</b><br /><i style="margin-right:5px" class="ri-time-fill"></i> <b style="font-size:16px">5:00 - 6:30 PM</b><br /><i style="margin-right:5px" class="ri-map-pin-2-fill"></i> <b style="font-size:16px">BSS 166</b>',
        size: 'third',
        show: true
    }
)
