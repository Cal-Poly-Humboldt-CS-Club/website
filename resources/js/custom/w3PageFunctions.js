...
function updateMenuItems() {
  ...
  links.forEach(link => {
    ...
    if (link.href.includes("https://csclubhumboldt.org") && !home_enabled) {
      ...
      link.classList.add("disabled");
    } else if (link.href.includes("https://csclubhumboldt.org/activities/hackathon25/index.html") && !hackathon_enabled) {
      link.classList.add("disabled");
...
function createMenuItems() {
  const menuItems = [
    ...
    { href: "https://csclubhumboldt.org/activities/hackathon25/index.html", iconClass: "ri-terminal-box-fill", text: "Hackathon", enabled: hackathon_enabled },
